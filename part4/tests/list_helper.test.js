...
describe('Favorites', () => {
  ...
  test('when list has six blogs, return blog that has the max like', () => {
  ...
  test('when list has Zero blog, return an empty object', () => {
...
describe('Most Blogs', () => {
  ...
  test('when list has only one blog, return an object of author and the number of blog', () => {
  ...
  test('when list has six blogs, return an object of author and the number of blogs', () => {
...
describe('Most Likes', () => {
  ...
  test('when list has only one blog, return an object of author and the number of likes', () => {
  ...
  test('when list has six blogs, return an object of author and the number of likes', () => {
